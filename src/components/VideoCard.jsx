         ...
         <div className='relative h-48 md:h-40 md:rounded-xl overflow-hidden'>
          ...
          <div className='flex text-white mt-3'>
            ...
            <div className='flex flex-col ml-3 overflow-hidden'>
              <span className='text-md lg:text-xs xl:text-sm font-bold line-clamp-2'>{video?.title}</span>
              <span className='text-[12px] lg:text-[10px] xl:text-[12px] font-semibold items-center flex mt-3 text-white/[0.7]'>{video.author.title}
