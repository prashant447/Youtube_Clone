...
const VideoDetails = () => {
  ...
  const fetchVideoDetails = () =>{
    ...
    const fetchRelatedDetails = () =>{
      setLoading(true)
      fetchApi(`video/related-contents/?id=${id}`)
      .then((res) => {
        // console.log(res)
  ...
  return (
    <>
        <div className='flex justify-center flex-row bg-black h-[calc(100%-56px)]'>
           ...
           <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
            ...
            <div className='flex justify-between items-center flex-col md:flex-row mt-4'>
                    ...
                    <div className='flex text-white mt-4 md:mt-0'>
                          <div className='flex items-center justify-center h-11 px-6 rounded-3xl bg-white/[0.15]'>
                              <AiOutlineLike className='text-xl text-white mr-3'/>
            ...
            <div className='flex flex-col py-6 px-4 overflow-y-auto lg:w-[350px] xl:w-[400px]'>
                  {
                  relatedVideos &&  relatedVideos?.contents?.map((item) =>{
                      if(item.type !== 'video'){
                      return false
                      }
                      return(
                         <div key = {item.index} >
                     <SuggestionVideo video={item?.video}/>
